...
<div class="newsTemp" id="{datatype}">
	...
	<table style="width:100%;margin-bottom:5px;" cellspacing="0" cellpadding="0">
		...
		<tr><td class="voteButtons">
			...
			<div style="line-height:100%;vertical-align:top;"><img onclick="openBox(<?php echo '{id}' ?>);" src="{image}" style="margin-right:10px;background-size:100%;max-width:180px;cursor:pointer;float:left">{description}</div> <span class="readMore" style="cursor:pointer;" onclick="openBox('{URL}', '{title}', '{id}', '{datatype}')">Read more..</span></div></td>
