...
<!--
<li style="padding:0;margin-bottom:7px;">
	<table cellpadding="0" cellspacing="0" style="width:100%;">
				...
				<table>
					<tr>
						<td style="vertical-align:top">
							<img src="{profile_img}" style="width:30px;">
						</td>
						<td style="padding:3px;margin-left:3px;font-family:'MyriadPro Regular';font-size:8pt;color:#717171;text-shadow:1px 1px 1px white;">{text}</td>
					</tr>
				</table>
			</td>
		</tr>
		<tr style="">
			<td>
				<table>
					<tr>
						<td style="padding-left:10px;font-family:'MyriadPro Regular';font-size:7pt;color:#a9aeaf;text-shadow:1px 1px 1px white;">
