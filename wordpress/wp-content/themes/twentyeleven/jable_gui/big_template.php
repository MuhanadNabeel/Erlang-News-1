	...
	<table style="width:100%;margin-bottom:5px;" cellspacing="0" cellpadding="0">
		...
		<tr><td class="voteButtons">
			...
			<td><div class="content">
				<div style="border:solid 5px #eeeeee;background:url({image}) 0 -100px no-repeat;width:100%;height:200px;margin-bottom:10px;margin-top:-5px;cursor:pointer;" onclick="openBox('{URL}', '{title}', '{id}', '{datatype}');"></div>
